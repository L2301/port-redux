    ...
    return (
        ...
        >
            ...
            <Tabs.Root className="mt-2" value={tab} onValueChange={setTab}>
                <Tabs.List className="flex mb-4 border-b border-gray-300 dark:border-gray-700">
                    <Tooltip.Root>
                        <Tooltip.Trigger className="default-ring">
                            <Tabs.Trigger value="from-planet" className={`flex justify-center px-3 py-2 border-b-2 default-ring  transition-colors text-gray-300 dark:text-gray-700 ${tab === 'from-planet' ? 'border-white font-semibold' : 'border-transparent'}`} disabled={true}>From Planet</Tabs.Trigger>
                        </Tooltip.Trigger>
                    ...
                    <Tabs.Trigger value="manual" className={`flex justify-center px-3 py-2 border-b-2 default-ring transition-colors ${tab === 'manual' ? 'border-black dark:border-white font-semibold' : 'border-transparent'}`}>Existing Key File</Tabs.Trigger>
                </Tabs.List>
                <Tabs.Content value="from-planet" className="default-ring">
                    <div>
                    ...
                    <div>
                        ...
                        <select {...form.register('planet' as never, { validate: fromPlanetValidate })} className="input w-full mt-2 bg-white dark:bg-black">
                ...
                <Tabs.Content value="manual" className="default-ring">
                    <div>
